...
export const getNFTMetadata = async (connection: anchor.web3.Connection, txid: string) => {
  let txinfo = await connection.getConfirmedTransaction(txid)
  console.log("txinfo", txinfo)
  if(txinfo !== null){
  console.log("puk puk meta")
  let mintPubkey = new PublicKey(txinfo.transaction.instructions[3].keys[0].pubkey);
